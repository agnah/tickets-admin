...
const Badge = ({ classes, text, ticketEstado }) => {
  ...
  return (
    <div className={`badge-container ${classes}`}>
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="93" height="32">
        <g id="Grupo_399" data-name="Grupo 399" transform="translate(-385.525 -218)">
          ...
          <text id={text} data-name={text} transform="translate(414.122 231.212)" fill="#fff" fontSize="12" fontFamily="Encode Sans Condensed Thin" fontWeight="600" alignment-baseline="middle" text-anchor="middle" x="26%" y="21%"><tspan>{text}</tspan></text>
        </g>
      </svg>
    </div>
  )
