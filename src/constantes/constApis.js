export const apis = {
  // API_TICKETS: './assets/ticket.json',
  API_TICKETS: 'http://localhost:8000/api/tickets/inicio/',
  API_TICKETS_DETALLE: '../../assets/ticket.json',
  // API_TICKETS: 'https://my.api.mockaroo.com/ticket.json?key=d2c25b50',
  // API_TICKETS: 'https://dummyjson.com/users?limit=100',
  API_USUARIOS: 'http://localhost:8000/api/usuario/list/',
